/**This component is for editing Podcast details and sending the update to the server */

import React, { useEffect, useState } from "react";
import axios from "axios";

export default function Edit({ display, change, id }) {
  ...
  useEffect(() => {
    ...
    setDescription("");
    setBy("");
    // if podcast id id not undefined extract token and make a get request for the podcast details
    if (id !== undefined) {
